...
const MagicCard = ({
  ...
  }, [entry?.isIntersecting, isMobile, onEnterViewport]);
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "pointer-events-none absolute inset-0 h-full w-full rounded-2xl bg-gray-300 transition-opacity duration-500 dark:bg-slate-700",
